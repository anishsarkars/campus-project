...
export function Footer() {
  return (
    <footer className="w-full flex flex-col items-center justify-center py-12 bg-background border-t border-border relative overflow-hidden">
        ...
        <div className="w-full flex items-center justify-center">
          <div className="w-full" style={{ minHeight: 120 }}>
            <div className="flex flex-col items-center justify-center">
              ...
              <span className="mt-2 text-xs text-muted-foreground/80 font-mono">
